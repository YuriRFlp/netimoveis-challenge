...
export default function Home() {
  ...
  return (
    <main className="pt-14 bg-secondary">
      ...
      <section className={`pt-16 ${isMobile ? 'flex-col bg-[#F7F9FA] px-4 pb-12' : 'justify-between items-baseline bg-gradient-to-r from-secondary to-[#E1E5E9] px-32 pb-24'}`}>
        <div className={`flex max-w-[1200px] min-[1600px]:mx-auto ${isMobile ? 'flex-col' : 'justify-between items-baseline'}`}>
      ...
      {isMobile
        ...
        :
          ...
          >
            <div className="min-[1600px]:max-w-[1200px] min-[1600px]:mx-auto">
              <MenuCard
                title={filtersContent.title}
                description={filtersContent.description}
                textButton={filtersContent.textButton}
      ...
      <section className={`py-16 ${isMobile ? 'bg-[#F7F9FA]' : 'px-32'}`}>
        ...
        <div className={`min-[1600px]:mx-auto max-w-[1200px] my-20 ${isMobile && 'mx-4'}`}>
        ...
        <div
          ...
          className={`rounded-xl min-[1600px]:mx-auto ${isMobile ? "mx-4 px-4 py-8" : "flex justify-between items-center py-7 px-10 max-w-[1200px]"}`}
        >
      ...
      <section className={`bg-[#FAF9F7] ${isMobile ? 'px-4 pt-20' : 'pt-28 pb-20 px-32'}`}>
        <div className={`min-[1600px]:mx-auto ${!isMobile && 'max-w-[1200px]'}`}>
      ...
      <div className={`${!isMobile && 'bg-[#FAF9F7]'}`}>
        <div className={`${!isMobile && "min-[1600px]:mx-auto min-[1600px]:px-0 min-[1600px]:max-w-[1200px] flex px-32 rounded-xl pb-20"}`}>
      ...
      <section className={`min-[1600px]:mx-auto ${isMobile ? 'mt-16' : 'mx-32 mt-10 max-w-[1200px]'}`}>
        <Menu
          options={tips}
      ...
      <div className="bg-[#EDF1F4]">
        <div className={`min-[1600px]:mx-auto min-[1600px]:px-0 ${isMobile ? 'px-4 py-8' : 'flex items-start px-32 max-w-[1200px]'}`}>
          <List
            title="A Netimóveis"
            items={[
              'Quem somos',
